...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\python_projects\Django_Checkbook_Project\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\python_projects\Django_Checkbook_Project\venv\Scripts\deactivate.nu'
